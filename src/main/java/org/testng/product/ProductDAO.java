...
public class ProductDAO implements Serializable {
    ...
    public List<ProductDTO> getProducts(int start, int total)
        ...
        try ( Connection connection = DBHelper.makeConnection();  PreparedStatement preparedStatement = connection.prepareStatement("SELECT * FROM Product LIMIT " + start + "," + total)) {
